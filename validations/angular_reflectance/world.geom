...
:VIS world OFF
:VOLU medium BOX 50.*mm 50.*mm 0.01*cm G4_WATER
:VIS medium ON
:ROTM RM0 0. 0. 0.
...
:VOLU transmission BOX 50.*mm 50.*mm 10.*mm G4_AIR
:VIS transmission ON
:COLOUR transmission 0. 1. 0.
:PLACE reflectance 1 world RM0 0.*mm 0.*mm (10.1)*mm
:PLACE transmission 1 world RM0 0.*mm 0.*mm (-10.1)*mm
