The MedLinac2 example provided with GEANT4 has been created 
in the GAMOS geometry format.  This demonstrates the creation
of a complex geometry using a number of parameters in the
geometry file using the :P feature.
